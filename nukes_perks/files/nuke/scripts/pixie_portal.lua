...
if (#players > 0) then
    ...
    local genome = get_genome(player)

    if (Random(1,2) == 1) then

        if (tbl1 == nil or #tbl1 == 0) then
    
            shoot(player, "mods/nukes_perks/files/nuke/entities/pixie_fire.xml", x, y, nil, genome)
        ...
        if (tbl2 == nil or #tbl2 == 0) then
            ...
            shoot(player, "mods/nukes_perks/files/nuke/entities/pixie_ice.xml", x, y, nil, genome)
        ...
        if (tbl3 == nil or #tbl3 == 0) then
            ...
            shoot(player, "mods/nukes_perks/files/nuke/entities/pixie_electric.xml", x, y, nil, genome)
        ...
        if (tbl4 == nil or #tbl4 == 0) then
            ...
            shoot(player, "mods/nukes_perks/files/nuke/entities/pixie_poison.xml", x, y, nil, genome)
